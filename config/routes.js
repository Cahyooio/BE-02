...
apiRouter.get("/api/v1/getprodukbykategori/:kategori", controllers.api.v1.produkController.getProdukByKategori);
...
apiRouter.get("/api/v1/getsemuapenawaran/:iduser", controllers.api.v1.penawaranController.listSemuaPenawaranByUser);
